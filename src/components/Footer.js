...
export default function Header() {
  ...
  <div class="container px-6 text-center pt-6 justify-center">
    <div class="flex justify-center center mb-6">
  ...
  <div class="text-center p-4 background-color: rgba(0, 0, 0, 0.2);">
    © 2021 Copyright:
